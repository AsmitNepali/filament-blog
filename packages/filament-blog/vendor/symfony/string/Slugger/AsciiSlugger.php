 ...
 */
class AsciiSlugger implements LocaleAwareInterface, SluggerInterface
{
    ...
    {
        if ($emoji !== false && ! class_exists(EmojiTransliterator::class)) {
    ...
    public function slug(string $string, string $separator = '-', ?string $locale = null): AbstractUnicodeString
    {
        ...
        $transliterator = [];
        if ($locale && ($locale === 'de' || str_starts_with($locale, 'de_'))) {
