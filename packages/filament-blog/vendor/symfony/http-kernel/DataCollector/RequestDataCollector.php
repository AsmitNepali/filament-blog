...
class RequestDataCollector extends DataCollector implements EventSubscriberInterface, LateDataCollectorInterface
{
    ...
    public function collect(Request $request, Response $response, ?\Throwable $exception = null): void
    {
        ...
        foreach ($this->data as $key => $value) {
            ...
            if ($key === 'request_headers' || $key === 'response_headers') {
    ...
    {
        return preg_match('{^application/(?:\w+\++)*json$}i', $this->data['request_headers']['content-type']) === 1;
    }
    ...
    public function getPrettyJson(): ?string
    {
        ...
        return json_last_error() === \JSON_ERROR_NONE ? json_encode($decoded, \JSON_PRETTY_PRINT) : null;
    }
