...
class ProfilerListener implements EventSubscriberInterface
{
    ...
    public function onKernelResponse(ResponseEvent $event): void
    {
        ...
        if ($this->collectParameter !== null && null !== $collectParameterValue = $request->get($this->collectParameter)) {
            $collectParameterValue === true || filter_var($collectParameterValue, \FILTER_VALIDATE_BOOL) ? $this->profiler->enable() : $this->profiler->disable();
        }
