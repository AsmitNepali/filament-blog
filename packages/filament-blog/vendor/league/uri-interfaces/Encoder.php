...
final class Encoder
{
    ...
    public static function encodeQueryKeyValue(mixed $component): ?string
    {
        ...
        return match (true) {
            ...
            preg_match(self::REGEXP_CHARS_INVALID, $component) === 1 => rawurlencode($component),
            preg_match($pattern, $component) === 1 => (string) preg_replace_callback($pattern, $encodeMatches(...), $component),
            default => $component,
        };
    }
    ...
    private static function decode(Stringable|string|int|null $component, Closure $decodeMatches): ?string
    {
        ...
        return match (true) {
            $component === null => null,
            preg_match(self::REGEXP_CHARS_INVALID, $component) === 1 => throw new SyntaxError('Invalid component string: '.$component.'.'),
            preg_match(self::REGEXP_CHARS_ENCODED, $component) === 1 => preg_replace_callback(self::REGEXP_CHARS_ENCODED, $decodeMatches(...), $component),
            default => $component,
        };
    }
}
